              ...
              <div className="right">
                ...
                <div className="dots">
                  ...
                  <div className="dot">
                    <img src="/img/dot.png" alt="" />
                    <div className="dotText">
                      Почала інвестувати у <span>2022</span> році. Мій капітал
                      на фондовому ринку становить більше <span>48’000$ +</span>
                      ;
                    </div>
                  </div>
                  <div className="dot">
                    <img src="/img/dot.png" alt="" />
                    <div className="dotText">
                      Середня прибутковість портфелю за{" "}
                      <span>3 роки 23,5 %</span>;
                    </div>
                  </div>
                  <div className="dot">
                    <img src="/img/dot.png" alt="" />
