    ...
    <Fragment>
      ...
      <div className='givedMe'>
        <div className='container'>
          ...
          <div className='eachTitle'>
            Але перед кожною інвестицією є свої заперечення, в свій час я сам їх
            мала і дуже добре розумію, що одне з них у тебе також є:
          </div>
        ...
        <div className='container'>
          ...
          <div className='shortList'>
            ...
            <div className='numItem'>
              ...
              <div className='text'>
                ВГотовий інвест портфель з etf фондів, який дасть 10%
