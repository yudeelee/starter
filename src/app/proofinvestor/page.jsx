              ...
              <div className="dots">
                <div className="dot">
                  ...
                  <div className="dotText">
                    Аудитор, власниця та <span>CEO</span> компанії
                    <span> БУХГАЛТЕР КОНСУЛЬТАНТ</span> та{" "}
                    <span>АУДИТ КОНСУЛЬТАНТ</span>;
                  </div>
                </div>
                <div className="dot">
                  <img src="/img/dot.png" alt="" />
                  <div className="dotText">
                    Розвиваю особистий бренд в <span>Instagram</span> та{" "}
                    <span>YouTube</span>;
                  </div>
                </div>
                <div className="dot">
                  <img src="/img/dot.png" alt="" />
                  <div className="dotText">
                    Почала інвестувати у <span>2022</span> році. Мій капітал на
                    фондовому ринку становить більше <span>48’000$ +</span>;
                  </div>
                </div>
                <div className="dot">
                  <img src="/img/dot.png" alt="" />
                  <div className="dotText">
                    Середня прибутковість портфелю за <span>3 роки 23,5 %</span>
                    ;
                  </div>
                </div>
                <div className="dot">
                  <img src="/img/dot.png" alt="" />
                  <div className="dotText">
                    Автор курсу по інвестуванню <span>PROOFINVESTOR</span>;
                  </div>
                </div>
              </div>
            </div>
