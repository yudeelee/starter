        ...
        <div className='container'>
          ...
          <div className='circleWrapper'>
            ...
            <div className='cirBody'>
              ...
              <div className='button'>ЗАЙНЯТИ МІСЦЕ</div>
            </div>
          </div>
        </div>
      </div>
      <div className='program'>
        <div className='container'>
          ...
          <div className='blackBack'>
            <div className='button zin'>ЗАЙНЯТИ МІСЦЕ</div>
            ...
            <div className='tarItem'>
              <div className='tarItemWrapper'>
                ...
                <div className='arrows'>
                  ...
                  <div className='arrItem'>
                    <img src='/img/triangle.png' alt='' />
                    <div className='whiteText'>Розбір мого інвест-портфелю</div>
                  </div>
                  <div className='arrItem'>
                    <img src='/img/triangle.png' alt='' />
                    <div className='whiteText'>
      ...
      <div className='theTime'>
        <div className='container'>
          <div className='theWrapper'>
            ...
            <div className='btnwr'>
              <div className='button mt4'>ПРИЄДНАТИСЯ ДО ІНТЕНСИВУ</div>
            </div>
          </div>
        </div>
      </div>
